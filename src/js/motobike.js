...
for (let index = 0; index < arrProduct.length; index++) {
    str += `
    <div class="product">
                <img src="../image/image-motobikePage/${arrProduct[index].hinh}" alt="">
...
for (let i = 0; i < arrNewEndow.length; i++) {
    ...
    <div class="column">
    <div class="endow-pic">
        <img src="../image/image-motobikePage/${arrNewEndow[i].hinh1}" alt="">
    </div>
    <div class="content">
...
for (let i = 0; i < arrNews.length; i++) {
    ...
    <div class="column">
    <div class="endow-pic">
        <img src="../image/image-motobikePage/${arrNews[i].hinh1}" alt="">
    </div>
    <div class="content">
